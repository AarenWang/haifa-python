    ...
    try:
        ...
        if args.visualize:
            ...
            if _RUNNING_AS_SCRIPT:
                ...
                from haifa_jq.jq_compiler import compile_to_bytecode, INPUT_REGISTER
                from haifa_jq.jq_vm import JQVM
            ...
            if selected_mode == "gui":
                try:
                    if _RUNNING_AS_SCRIPT:
                        ...
                        from compiler.vm_visualizer import VMVisualizer as vm_class
            ...
            if selected_mode == "curses":
                try:
                    if _RUNNING_AS_SCRIPT:
                        ...
                        from compiler.vm_visualizer_headless import VMVisualizer as vm_class
